  ...
  return (
      ...
      <main className='container mx-auto mt-5 md:mt-20 p-5 md:flex md:justify-center'>
       <div className='md:w-2/3 lg:w-2/5'>
         ...
         <Link 
         to={"/"}
         className="block text-center my-5 from-green-400 to-blue-500 -mb-5 w-full py-2 hover:from-pink-500 hover:to-yellow-500 text-violet-600 uppercase text-sm"
         >Regresar</Link>
