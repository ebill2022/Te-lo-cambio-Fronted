...
<>
      ...
      <main className='flex-1'>
        <div className="bg-gradient-to-r from-yellow-50 via-white to-yellow-50">
          <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
            <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
              ...
              <a href="#" className="hidden text-sm font-bold text-neutral-600 hover:text-black sm:block">
            ...
            <div className="mt-4 flow-root">
              <div className="-my-2">
                <div className="relative box-content h-80 overflow-x-auto py-2 xl:overflow-visible">
                  <div className="min-w-screen-xl absolute flex space-x-8 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl: grid-cols-5 xl:gap-x-8 
                  xl:space-x-0 xl:px-0">
        ...
        <div className="bg-gradient-to-r from-white via-yellow-50 to-white">
          <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            <h2 className="text-2xl font-bold tracking-tight text-gray-900">los clientes tambien compraron</h2>
                ...
                <div key={product._id}>
                  <div className="relative">
                    ...
                    <div className="relative mt-4">
                      ...
                      <p className="mt-1 text-sm text-gray-500">{product.stock + " un"}</p>
                    </div>
                  ...
                  <div className="mt-6">
                    <a
                      href={product.href}
                      className="relative flex items-center justify-center rounded-md border border-transparent bg-gray-100 py-2 px-8 text-sm 
                      font-medium text-gray-900 hover:bg-yellow-400">
            ...
            <footer className="text-center text-white background-color: #f1f1f1;">
              ...
              <div className="text-center text-gray-700 p-4 background-color: rgba(0, 0, 0, 0.2);">
                © 2022
                <a className="text-gray-800" href="https://tailwind-elements.com/">E1/G13-Mintic2022</a>
              </div>
            </footer>
          </div>
        </div>
